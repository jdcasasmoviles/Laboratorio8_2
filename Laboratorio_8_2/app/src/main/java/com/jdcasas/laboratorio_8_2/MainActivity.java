package com.jdcasas.laboratorio_8_2;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static String url_all_empresas = "http://masterwishmaster.esy.es/laboratorio8/get_all_empresas.php";
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog.setMessage("Cargando empresas. Por favor espere...");
